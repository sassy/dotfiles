...
1. Select the button to create a new project in the Azure Functions explorer
    ...
    ![createNewProject](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/createNewProject.png)
...
1. To start your project, press F5 or the "play" button
    ...
    ![debug](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/debug.png)
...
1. Expand your _local project_ in the Azure Functions explorer to copy your function's url
    ...
    ![debug2](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/debug2.png)
...
1. Select the "Detach" button to stop your project from running locally
    ...
    ![debug3](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/debug3.png)
...
1. Select the button to deploy
    ...
    ![deploy](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/deploy.png)
...
1. Wait for deployment to complete. Progress will be shown in the bottom right corner of your window
    ...
    ![deploy2](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/deploy2.png)
...
1. Once deployment is complete, expand your _subscription_ in the Azure Functions explorer to copy your deployed function's url
    ...
    ![deploy3](https://github.com/Microsoft/vscode-azurefunctions/raw/master/resources/readme/deploy3.png)
